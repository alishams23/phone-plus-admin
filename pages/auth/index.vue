                 ...
                 <v-row class="h-100">
                   <v-col cols="12" md="6" class="h-100">
                     <v-card-text class="mt-12" height="100%">
                       <h4
                         class="text-center text-h4 my-10 font-weight-black"
                       >ورود به اکانت</h4>
                       ...
                       <v-row align="center" justify="center">
                         ...
                         <v-btn class="mt-16" size="large" elevation="0" rounded color="primary" dark block tile>ورود</v-btn>
                         </v-col>
                       </v-row> 
                    </v-locale-provider> 
                     </v-card-text>
                   ...
                   <div style="  text-align: center; padding: 180px 0;">
                     ...
                     <div class="text-center">
                       <v-btn tile rounded variant="outlined" dark @click="step++" class="mt-10 font-weight-bold px-15">ثبت نام</v-btn>
                     </div>
                     </div>
                   </v-col>
                 </v-row>
                 ...
                 <v-row class=" h-100" >
                   <v-col cols="12" md="6" class="bg-primary rounded-br-xl h-100" >
                    <div style="  text-align: center; padding: 180px 0;">
                     ...
                     <div class="text-center">
                        <v-btn tile rounded variant="outlined" dark @click="step--" class="mt-10 font-weight-bold px-15">ورود </v-btn>
                     ...
                     <v-card-text class="mt-12">
                      ...
                      <v-locale-provider rtl  >
                       ...
                       <v-row align="center" justify="center">
                         ...
                         <v-btn class="mt-16" size="large" elevation="0" rounded color="primary" dark block tile>ثبت نام</v-btn>
