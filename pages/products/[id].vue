...
export default {
    ...
    methods: {
        ...
        async sendData() {
            ...
            axios.put(`http://192.168.225.128:8000/api/product/ProductUpdateApi/${this.$route.params.id}/`, formDic, {
                headers: {
                    Authorization: `Token ${useUserStore().userToken}`
                },
            })
        ...
        getData() {
            axios.get(`http://192.168.225.128:8000/api/product/Product_retrieve/${this.$route.params.id}/`, {
                headers: {
